...
$arCommands = array(
	array(
		...
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_findFirst'),
	),
	array(
		'TITLE' => 'findRandom',
		'COMMAND' => 'Debug::findRandom()',
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_findRandom'),
	),
	array(
		'TITLE' => 'findSelected',
		'COMMAND' => 'Debug::findSelected(1234567890)',
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_findSelected'),
	),
	array(
		'TITLE' => 'generateFirst',
		'COMMAND' => 'Debug::generateFirst()',
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_generateFirst'),
	),
	array(
		'TITLE' => 'generateRandom',
		'COMMAND' => 'Debug::generateRandom()',
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_generateRandom'),
	),
	array(
		'TITLE' => 'generateSelected',
		'COMMAND' => 'Debug::generateSelected(1234567890)',
		'TEXT_MODE' => 'N',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_generateSelected'),
	),
	array(
		'TITLE' => 'showFilter',
		'COMMAND' => 'Debug::showFilter()',
		'TEXT_MODE' => 'Y',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_showFilter'),
	),
	array(
		'TITLE' => 'showOffersFilter',
		'COMMAND' => 'Debug::showOffersFilter()',
		'TEXT_MODE' => 'Y',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_showOffersFilter'),
	),
	array(
		'TITLE' => 'showFilterSql',
		'COMMAND' => 'Debug::showFilterSql()',
		'TEXT_MODE' => 'Y',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_showFilterSql'),
	),
	array(
		'TITLE' => 'showOffersFilterSql',
		'COMMAND' => 'Debug::showOffersFilterSql()',
		'TEXT_MODE' => 'Y',
		'HINT' => Loc::getMessage('DATA_EXP_TAB_CONSOLE_showOffersFilterSql'),
	),
);

?>
<div class="data-exp-console">
	<div class="data-exp-console-fast-commands">
	...
	<div class="data-exp-console-text">
	...
	<div class="data-exp-console-button">
		<input type="button" value="<?=Loc::getMessage('DATA_EXP_TAB_CONSOLE_EXECUTE');?>" data-role="console-execute" />
		&nbsp;
		<label>
			<input type="checkbox" data-role="console-type"<?if($strConsoleText=='Y'):?> checked="checked"<?endif?> />
			<?=Loc::getMessage('DATA_EXP_TAB_CONSOLE_TYPE');?>
		</label>
	</div>
	<div class="data-exp-console-results" data-role="console-results"></div>
</div>