...
if($APPLICATION->GetGroupRight($strModuleId) != 'D'){
	...
	$arSubmenu = [];
	$arSubmenu[] = array(
		'text' => Loc::getMessage('DATA_EXP_MENU_NEW_TITLE').(!$bOldCoreDisabled?Loc::getMessage('DATA_EXP_MENU_NEW_TITLE_'):''),
	...
	$aMenu = array(
		...
		'sort' => $intSort,
		'text' => $strModuleName,
		'title' => Loc::getMessage('DATA_EXP_MENU_TEXT'),
		'url' => '',
		'icon' => 'data_exp_menu_icon',
		'page_icon' => '',
