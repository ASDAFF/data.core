<?
// General
$MESS['DATA_EXP_PAGE_TITLE'] = 'Миграция профилей из старого ядра модуля в новое';
...
$MESS['DATA_EXP_NOTICE'] = '<b style="color:red">Мигратор профилей работает в тестовом режиме!</b><br/><br/>
...
';
$MESS['DATA_EXP_SITE_PREFIX'] = 'Сайт';
$MESS['DATA_EXP_ALREADY_MIGRATED'] = '<a href="#URL#" target="_blank" style="color:green;font-style:italic;">уже мигрирован! (ID=#ID#)</a>';
$MESS['DATA_EXP_SELECT_ALL'] = 'Выбрать все';
$MESS['DATA_EXP_SELECT_NONE'] = 'Отменить выбор';
$MESS['DATA_EXP_SELECT_INVERT'] = 'Инвертировать выбор';
$MESS['DATA_EXP_MIGRATE_BUTTON'] = 'Выполнить миграцию';

// Popup: backup restore
$MESS['DATA_EXP_TAB_GENERAL_NAME'] = 'Профили';
$MESS['DATA_EXP_TAB_GENERAL_DESC'] = 'Выберите профили для перевода на новое ядро';

$MESS['DATA_EXP_NO_MIGRATABLE_PROFILES'] = 'Нет профилей, которые можно мигрировать в новое ядро.';
